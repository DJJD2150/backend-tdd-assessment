...
__author__ = """DJJD2150, Group Session written by Jack Detke,
...
class TestEcho(unittest.TestCase):
    ...
    def test_title_short(self):
        """Check if short option '-t' performs capitalization"""
        args = ["-t", "hello world"]
        with Capturing() as output:
            self.module.main(args)
        assert output, "The program did not print anything."
    ...
    def test_title_long(self):
        """Check if long option '--title' performs capitalization"""
    ...
    def test_all_flags(self):
        """Check if 3 flags listed as one '-ltu', '-tul', or '-ult' performs last
    ...
    def test_no_flags(self):
        """Check if there are no flags listed, the message prints out as entered."""
        args = ["hello"]
        with Capturing() as output:
            self.module.main(args)
        assert output, "The program did not print anything."
